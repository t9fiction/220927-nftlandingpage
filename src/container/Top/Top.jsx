...
const CollectionsChoice = ({ collection: {number, imgUrl, title, icon, bid, percen }}) => (
  <div className='app__colection_choice'>
    <div className="app__collection_content">
    <h1 className='app__collection_number'>{number}</h1>
    <img src={imgUrl} alt="Collection Img" />
      <div className='app__collection_notes'>
        <a href="#" className='app__collection_title'>{title}</a>
          <div className='app__collection_bid'>
...
const Top = () => {
  return (
    <div className="app__top section__padding">
      <div className="app__top_left">
        <div className="app__top_left_main">
          <img className='left__main_img' src={images.gradient_1} alt="Gradient 1" />
        ...
        <div className="app__top_left_children_content">
          <div className="app__top_left_children">
